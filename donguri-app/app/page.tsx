...
export default function Home() {
  return (
    <main className="h-dvh overflow-hidden flex flex-col items-center bg-gradient-to-b from-green-50 to-green-100 px-4">
      {/* ロゴ・ヒーローセクション */}
      <div className="text-center flex-shrink-0 pt-8 pb-4">
      ...
      {/* CTAボタン */}
      <div className="flex flex-col gap-3 w-full max-w-sm flex-shrink-0 pb-8">
        <Link
          href="/register"
          className="bg-green-600 text-white text-center py-3 rounded-xl font-bold text-lg shadow-lg hover:bg-green-700 transition-colors"
        >
          はじめる（無料）
        </Link>
        <Link
          href="/login"
          className="bg-white text-green-600 text-center py-3 rounded-xl font-bold text-lg border-2 border-green-600 hover:bg-green-50 transition-colors"
        >
          ログイン
        </Link>
